      ...
      <div className="flex flex-col md:flex-row items-center md:items-start md:gap-20">
        ...
        <div className="flex flex-col items-center md:items-start mt-10 text-gray-600">
          ...
          <p className="my-10 max-w-lg">
            Discover your perfect home with us. Whether you’re buying, selling,
            or renting, our friendly experts guide you every step of the way.
            Explore a wide range of properties matched to your lifestyle and
            budget. Start your journey to your dream space today!
          </p>
